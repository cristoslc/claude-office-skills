...
**Out of scope:**
- Replacing LibreOffice (no Python alternative exists)
...
| SPEC-005 | Update Documentation | Active | SPEC-004 |

## Key Dependencies

- SPIKE-001 (Complete) — established Deno as the Node.js runtime choice
- LibreOffice remains the sole system tool that cannot be replaced
